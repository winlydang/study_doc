...
class BrushTicket(object):
    ...
    def __init__(self, passengers, from_time, from_station, to_station, number, seat_type, receiver_mobile,
        ...
        # browser = webdriver.Chrome("C:/Users/Administrator/Downloads/chromedriver_win32/chromedriver.exe",chrome_options=options)
        # browser.get(addr)
        self.driver = Browser(driver_name=self.driver_name)
# 汪登雄  2019-01-27 D1849  二等座
# 党芳娥  2019-01-27 C7012  二等座
    def do_login(self):
        """登录功能实现，手动识别验证码进行登录"""
...
if __name__ == '__main__':
    ...
    city_list = {
        ...
        'cdd': '%u6210%u90FD%u4E1C%2CICW',# 成都东
